...
<br>
<div style=" background-color:#333;max-width:600px; max-height:600px; padding:1em 1em;position:relative;margin:auto;">
...
<div class="mySlides fade" style="display: none;">
  ...
  <div class="text">scrollspy example</div>
</div>
...
<div class="mySlides fade" style="display: none;">
  ...
  <img src="Photo7.jpg" style="width:100%">
  <div class="text">Screenshot</div>
</div>

<div class="mySlides fade" style="display: none;">
  <div class="numbertext">7 / 7</div>
  <img src="Photo8.jpg" style="width:100%">
  <div class="text">Screenshot</div>
</div>
...
<div style="text-align:center">
  ...
  <a href="javascript:void(0)" class="dot" onClick="currentSlide(5)" title="slide 5"></a>
  <a href="javascript:void(0)" class="dot" onClick="currentSlide(6)" title="slide 6"></a>
  <a href="javascript:void(0)" class="dot" onClick="currentSlide(7)" title="slide 7"></a>
</div>
